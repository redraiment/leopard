...
insert into product_checkin_records (product_id, rack_id, has_markded, count, date) values (1, 'A1', false, 100, CURRENT_DATE);
insert into product_checkin_records (product_id, rack_id, has_markded, count, date) values (1, 'A2', true, 75, CURRENT_DATE);
insert into product_checkin_records (product_id, rack_id, has_markded, count, date) values (1, 'A1', false, 50, CURRENT_DATE);
